...
record ΠU-ucwf-⇒ (src trg : ΠU-ucwf) : Set₁ where
  open ΠU-ucwf src renaming (λucwf to λucwf₁ ; Π to Π₁ ; U to U₁)
  open ΠU-ucwf trg renaming (λucwf to λucwf₂ ; Π to Π₂ ; U to U₂)
...
record ΠU-ucwf-≅ {Πu₁ Πu₂} (Πu₁-⇒ : ΠU-ucwf-⇒ Πu₁ Πu₂)
                              (Πu₂-⇒ : ΠU-ucwf-⇒ Πu₂ Πu₁) : Set₁ where
  open ΠU-ucwf Πu₁ renaming (λucwf to λu₁)
  open ΠU-ucwf Πu₂ renaming (λucwf to λu₂)
  open ΠU-ucwf-⇒ Πu₁-⇒ renaming (λucwf-⇒ to λu₁-⇒)
  open ΠU-ucwf-⇒ Πu₂-⇒ renaming (λucwf-⇒ to λu₂-⇒)
  open λβη-ucwf-⇒ λu₁-⇒ renaming (ucwf-⇒ to u₁-⇒)
